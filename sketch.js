...
function preload() {
  ...
  arrowSound = loadSound("assets/Arrow+Swoosh+1.mp3");
  gameOverSound = loadSound("assets/gosound.wav");
  bgmusic = loadSound("assets/bgmusicc.mp3");
}
